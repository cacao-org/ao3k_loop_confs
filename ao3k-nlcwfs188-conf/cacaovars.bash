...
export CACAO_LOOPNAME="nlcwfs188"
...
# input WFS stream
# export CACAO_WFSSTREAM="orcam_near"    # Hardware stream, connected to physical camera
export CACAO_WFSSTREAM="orcam_near"    # Hardware stream, connected to physical camera
export CACAO_WFSSTREAMSIM="orcam_sim" # Simulation camera stream
